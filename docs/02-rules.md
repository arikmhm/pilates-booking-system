...
| A6 | Kelas & paket | Dua tabel: **jenis kelas** (yang diajarkan, masuk jadwal, tanpa harga) dan **paket** (yang dibayar — kredit, masa berlaku, jenis kelas tempat kredit itu berlaku) · aksi per baris di menu "⋯", formulirnya dialog dari URL (DS-56) · jenis kelas selalu bisa diubah, paket hanya selama belum dibeli siapa pun (DS-53) · peringatan **kursi vs kredit** muncul hanya saat kursi terjadwal kurang dari kredit yang sudah terjual (DS-55) — `src/app/admin/layanan/` |
