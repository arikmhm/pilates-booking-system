...
| A6 | Kelas & paket | **Dua hal yang gampang tertukar, dan layarnya harus mengatakan bedanya** (DS-54): jenis kelas = apa yang diajarkan dan masuk jadwal, tanpa harga; paket = apa yang dibayar, berisi kredit + masa berlaku + daftar jenis kelas tempat kredit itu berlaku · tambah jenis kelas, hapus yang belum dipakai · buat paket baru, sembunyikan paket lama · **kursi vs kredit** — kredit terjual yang terkunci di satu jenis kelas lawan kursi kosong terjadwal sebelum kredit itu hangus (DS-55) — `src/app/admin/layanan/` |
